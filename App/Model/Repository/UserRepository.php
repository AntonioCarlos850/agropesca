...
class UserRepository extends Repository {
    static function getUserById($id){
        return self::selectRow(
            "SELECT blg_user.*,
                blg_user_autor.slug AS autor_slug,
                blg_user_autor.slug AS autor_name,
                blg_user_autor.slug AS autor_description,
                blg_user_autor.slug AS autor_creation_date,
                blg_user_autor.slug AS autor_update_date,
                blg_user_type.name AS type_name
            FROM blg_user 
                LEFT JOIN blg_user_autor ON blg_user_autor.user_id = blg_user.id
